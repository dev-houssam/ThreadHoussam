...
int main()
{
    ...
    Personne personne1 = {.nom="Houssam"};
    Personne personne2 = {.nom="Islam"};
    Personne personne3 = {.nom="Rachid"};
    thread_create(&afficherPersonne, (void *) &personne1);
    thread_create(&afficherPersonne, (void *) &personne2);
    thread_create(&afficherPersonne, (void *) &personne3);
    thread_start();
